...
![PSP AD data naming convention](/image/docs/psp-ad-data-naming-convention.png)
...
![ALS Differential Expression data naming convention](/image/docs/als-differential-expression-data-naming-convention.png)
