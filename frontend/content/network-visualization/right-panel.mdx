...
![Right panel of network visualization page](/image/docs/right-panel.png)
...
![Community detection](/image/docs/community-detection.png)
...
![Edge weight cut-off](/image/docs/edge-weight-cut-off.png)
...
![Node degree cut-off](/image/docs/node-degree-cut-off.png)
...
![Hub genes](/image/docs/hub-genes.png)
...
![Legends when selecting Druggability in Node Color](/image/docs/legends-in-druggability.png)
...
![Change Link Distance](/image/docs/change-link-distance.png)

![Change Charge Strength](/image/docs/change-charge-strength.png)
...
![Change Node Size](/image/docs/change-node-size.png)

* **Node Label Size**

You can make node label size larger/smaller.

![Change Node Label Size](/image/docs/change-node-label-size.png)

* **Label Density**

You can change the label density here.

![Change Label Density](/image/docs/change-label-density.png)

* **Show Edge Label**

You can make edge label (edge weight) appear/disappear. To view more edge labels, simply zoom in the network.

![Show Edge Label](/image/docs/show-edge-label.png)
