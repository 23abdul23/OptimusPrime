...
![Network visualization page](/image/docs/network-visualization-page.png)
...
![Gene information showing up while hovering/clicking the node](/image/docs/gene-info-on-clicking.png)
